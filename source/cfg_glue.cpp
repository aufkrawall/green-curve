...
//
// ONLY the llvm-mingw toolchain compiles this file.  The MSVC-ABI (clang-cl)
// toolchain gets real OS-enforced CFG through the PE load config instead and
// does not need — or want — this shim; its shared runtime half lives in
