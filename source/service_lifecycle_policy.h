...
static inline bool service_build_profile_transition_request(
    ...
    *requestOut = *nextIntent;
    ...
    // The video knob is not part of portable profiles, so ANY profile
    // selection clears it - a manual experiment must never silently survive
    // into a named profile's ownership.
